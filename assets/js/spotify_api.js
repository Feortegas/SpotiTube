...
var _getPlaylist = function (_token, _playListId) {
  const playlists = fetch(
    "https://api.spotify.com/v1/playlists/" + _playListId,
    {
      method: "GET",
...
var searchSpotifyHandler = function () {
  ...
  if (playlistName) {
    // clear or hide track list, thumbnails, and search input
    tracksEl.innerHTML = "";
...
document
  .querySelector("#search-spotify")
  .addEventListener("click", searchSpotifyHandler);
